...
let students = ['Tony', 'Marchall', 'Rhys', 'Ray', 23 , true, ['Ryan', 'Iesha', 'Amira']];

// console.log(typeof students);
console.log(students instanceof Array); // the instaceof operator is used to check the type of an object at run time. Remember that arrays are technically objects.
...
//Remove and insert
food.splice(1, 1, 'Bananas'); // Removecs Shrimp and add Banana => (position, how many to remove, what to add)
...
// We can use a method called length() that can tell us how many values are within out array.
...
*/
///-------------------MINE
let movieList =['LiarLiar', 'Ace Ventura', 'Billy Madison', 'Happy Gilmore', 'The Mask', 'Fun with Dick and Jane']

movieList.forEach((movieList, index) => {
    console.log(movieList);
    console.log(index);
})

movielist.pop();
console.log('pop: ', movieList);

movieList.splice(1, 1, 'The Grinch'); 
console.log('splice: ', movieList);
