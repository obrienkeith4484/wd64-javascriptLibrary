...
function fetchSpace(e) {
    ...
    .then(results => {
        ...
        return results.json() // This method takes in a response (results), reads to competion and returns the results as a json format
    })
    .then(json => {
        // console.log(json)
        displayRockets(json);
...
function displayRockets(data) {
    ...
    let rockets = data.forEach()
        console.log(r);
        let rocket = documents.createElement('11'); // create a li tag
